...
(function($) {
  ...
  if (window.innerWidth < 992) {
    ...
    alertify.success("Have a good day, everyone! I'm Trung Quan from Viet Nam.(from with LOVES).ahihi", 7);
  } else {
    alertify.set("notifier","position", "top-right");
    alertify.success("Have a good day, everyone! I'm Nhật Lệ from Viet Nam.(from with LOVES).", 7);
  }
